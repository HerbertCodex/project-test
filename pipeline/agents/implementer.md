...
Comments are contracts, never narration: structured docs on every export, nothing else. The why of a non-obvious decision goes in the commit message. `comment_policy` refuses the narration.
## STACK WORKFLOW
